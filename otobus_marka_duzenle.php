<?php
	...
	$SAYFA_DATA = array(
		'title' 	=> 'Markasını Düzenle',
		'action_id' => Actions::OTOBUS_MARKA_DUZENLE
	);
		...
		<div class="section-content">
			...
			<form action="" method="post" id="duzenle">
				...
				<div class="input-container">
					...
					<input type="text" name="marka" id="ekle_marka" class="req" value="<?php echo $MARKA->get_details("marka")?>" />
				</div>

				<div class="input-container submit-center">
					<input type="hidden" name="type" value="marka_duzenle" />
